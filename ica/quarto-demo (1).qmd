...
> It looks nice when it's in visual mode.
...
> This is stored in my ICA folder and I cannot edit the html.
> It looks like a nice document on a website.
...
> preserves an empty line

`![](url)`

> attaches a link/photo
...
-   Press the green arrow in the top right of the chunk.
    What happens in the qmd?

-   Render.
    What appears in the html: R code, output, or both?

    > the answer shows up in the qmd and in the html r code and output show up
...
```{r}
# names 10 to be temperature_c and then calculates a value based on temperature_c and assigns it temperature_f. then it outputs the final value of temperature_f
temperature_c <- 10
